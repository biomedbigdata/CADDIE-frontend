...
import { AddExpressedProteinsComponent } from './pages/explorer-page/components/sidebar/dialogs/add-expressed-proteins/add-expressed-proteins.component';
...
import { DiseaseRelatedGenesComponent } from './pages/explorer-page/components/sidebar/dialogs/disease-related-genes/disease-related-genes.component';
...
} from './pages/explorer-page/components/sidebar/dialogs/launch-analysis/launch-analysis-category-dropdown/launch-analysis-category-dropdown.component';
import { AddCancerExpressedGenesComponent } from './pages/explorer-page/components/sidebar/dialogs/add-cancer-expressed-genes/add-cancer-expressed-genes.component';
